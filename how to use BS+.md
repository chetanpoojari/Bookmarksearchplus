...
2.  **Pin the Extension (Recommended)**
    ...
    *   Click the **Bookmark icon** ⛉ (Extensions menu) in the Chrome toolbar.
...
1.  Open Chrome’s **Bookmarks Manager** (Ctrl + Shift + O or Cmd + Option + B on Mac).
...
1.  Click the **⚙️ Settings icon** in the top right of the BS+ search bar.
...
Many users ask why **Bookmark Search Plus (BS+) uses a tag-based system** instead of relying solely on nested folders for organization. Here’s why **tags offer a more efficient and flexible solution:**
...
*   **Tags allow bookmarks to belong to multiple categories** simultaneously.
    ...
    *   Example: A webpage about **AI in Product Management** could be placed in a **“Product Management”** folder or an **“AI”** folder, but **not both**.
...
*   Tags scale effortlessly – **no need to reorganize folders**, just tag and search as needed.
...
We’re continuously improving BS+! If you have feature suggestions or find bugs:🔹 Use the **Report a Bug** form in **Settings**.
